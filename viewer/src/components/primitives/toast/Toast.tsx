...
const toastVariants = cva(
  cn(
    "bg-cur-scheme-3 text-cur-scheme-12",
    "group pointer-events-auto",
    "relative flex w-full items-center justify-between gap-regular",
    "overflow-hidden",
    "border",
    "p-comfortable pr-xcomfortable",
    "shadow-lg",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn("absolute right-2 top-2 p-1", className)}
    toast-close=""
    {...props}
  >
    <CloseIcon label="close toast" size="sm" />
  </ToastPrimitives.Close>
));
